...
class MessagePackKitDecodingTests: XCTestCase {
    ...
    func testDecodeDate() {
        ...
        var value: Date?
        XCTAssertNoThrow(value = try decoder.decode(Date.self, from: data))
    ...
    func testDecodeDictionaryWithDate() {
        ...
        XCTAssertNoThrow(value = try decoder.decode([String: Date].self, from: data))
